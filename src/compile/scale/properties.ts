...
import {MarkDef, BarConfig} from '../../mark';
...
export function getDefaultValue(
  ...
  switch (property) {
    ...
    case 'padding':
      return padding(channel, scaleType, scaleConfig, markDef, config.bar);
    case 'paddingInner':
...
export function padding(channel: Channel, scaleType: ScaleType, scaleConfig: ScaleConfig, markDef: MarkDef, barConfig: BarConfig) {
